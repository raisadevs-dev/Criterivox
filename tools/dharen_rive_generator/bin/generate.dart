...
const purple = RiveColor.fromArgb(0xFF8B78FF);
const deepPurple = RiveColor.fromArgb(0xFF34286F);
const pale = RiveColor.fromArgb(0xFFEAE8F8);
const dark = RiveColor.fromArgb(0xFF17143A);
const cyan = RiveColor.fromArgb(0xFF63D7C1);
const warning = RiveColor.fromArgb(0xFFFFB4A8);

void main() async {
  final file = RiveFileBuilder();
  final artboard = file.addArtboard(name: 'Dharen', width: 420, height: 520);

  final torso = artboard.addRectangle(
    x: 210,
    y: 390,
    shapeWidth: 170,
    shapeHeight: 150,
    ...
    stroke: purple,
    strokeWidth: 3,
    shapeName: 'DharenBody',
  );

  final head = artboard.addCircle(
    x: 210,
    y: 210,
    radius: 112,
    fill: pale,
    stroke: purple,
    strokeWidth: 9,
    shapeName: 'DharenHead',
  );

  final leftEye = artboard.addEllipse(
    x: 170,
    y: 215,
    radiusX: 13,
    radiusY: 20,
  ...
  final rightEye = artboard.addEllipse(
    x: 250,
    y: 215,
    radiusX: 13,
    radiusY: 20,
  ...
  final leftHand = artboard.addCircle(
    x: 105,
    y: 392,
    radius: 22,
    fill: deepPurple,
  ...
  final rightHand = artboard.addCircle(
    x: 315,
    y: 392,
    radius: 22,
    fill: deepPurple,
  ...
  final idle = artboard.addAnimation(
    'IDLE',
    fps: 60,
    durationFrames: 120,
    loop: LoopType.loop,
    animatedProperties: [
      ...
      AnimatedProperty(targetObjectId: leftEye, propertyKey: CoreProperty.scaleY, frame: 0, value: 1),
      ...
      AnimatedProperty(targetObjectId: rightEye, propertyKey: CoreProperty.scaleY, frame: 0, value: 1),
  ...
  final receive = artboard.addAnimation(
    'RECEIVE',
    fps: 60,
    durationFrames: 36,
    loop: LoopType.oneShot,
    animatedProperties: [
      ...
      AnimatedProperty(targetObjectId: core, propertyKey: CoreProperty.scaleX, frame: 0, value: 1),
  ...
  final work = artboard.addAnimation(
    'WORK',
    fps: 60,
    durationFrames: 90,
    loop: LoopType.loop,
  ...
  final communicate = artboard.addAnimation(
    'COMMUNICATE',
    fps: 60,
    durationFrames: 72,
    loop: LoopType.loop,
  ...
  final handoff = artboard.addAnimation(
    'HANDOFF',
    fps: 60,
    durationFrames: 60,
    loop: LoopType.oneShot,
  ...
  final complete = artboard.addAnimation(
    'COMPLETE',
    fps: 60,
    durationFrames: 60,
    loop: LoopType.oneShot,
  ...
  final warningAnim = artboard.addAnimation(
    'WARNING',
    fps: 60,
    durationFrames: 48,
    loop: LoopType.loop,
  ...
  artboard.addStateMachine(
    'DharenLifecycle',
    inputs: [
      for (final name in stateAnimations) TriggerInput(name.$1),
    ],
    layers: [
      StateMachineLayerDef(
        name: 'DharenLifecycleLayer',
        states: [
          for (final entry in stateAnimations)
            AnimationStateDef(name: entry.$1, animationId: entry.$2),
        ],
        transitions: [
          for (final name in stateAnimations)
            TransitionDef(
              durationMs: 260,
              conditions: [TriggerCondition(name.$1)],
            ),
        ],
      ),
    ],
