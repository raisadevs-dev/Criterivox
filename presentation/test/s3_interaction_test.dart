...
void main() {
  testWidgets('Bloom exposes capability gateway and activates Analyze', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(home: Bloom(onSelected: (value) => selected = value)));
  ...
  testWidgets('Syvax accepts suggested input and submits it', (tester) async {
    String? submitted;
    await tester.pumpWidget(MaterialApp(home: Syvax(onSubmit: (value) => submitted = value)));
