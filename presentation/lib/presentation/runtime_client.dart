...
class CharacterRuntimeClient {
  ...
  void sendChat({String? taskId, required String message, String targetCharacter = 'syvax', Map<String, dynamic> data = const {}, Map<String, dynamic> context = const {}, List<Map<String, dynamic>> references = const []}) {
    _send({'type': 'chat_message', 'target_character': targetCharacter, if (taskId != null) 'task_id': taskId, 'message': message, 'data': data, 'context': context, 'references': references});
  }
  ...
  void _send(Map<String, dynamic> payload) {
    ...
    if (channel == null) {
      _scheduleReconnect();
      _errors.add('Python runtime is reconnecting.');
      return;
    }
