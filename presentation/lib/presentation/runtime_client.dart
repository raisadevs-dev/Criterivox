...
class CharacterRuntimeClient {
  ...
  void buildContext({required String foundationId,Map<String,dynamic> userIntentContext=const {},String? taskId})=>_send({'type':'context_build','foundation_id':foundationId,'user_intent_context':userIntentContext,if(taskId!=null)'task_id':taskId});
