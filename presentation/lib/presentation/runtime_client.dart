...
class CharacterRuntimeClient {
  ...
  void buildContext({required String foundationId,Map<String,dynamic> userIntentContext=const {}}){_send({'type':'context_build','foundation_id':foundationId,'user_intent_context':userIntentContext});}
