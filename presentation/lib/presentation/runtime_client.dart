...
class CharacterRuntimeClient {
  ...
  void ingestFolder({required String folderPath,Map<String,dynamic> suppliedContext=const {}}){_send({'type':'data_folder','folder_path':folderPath,'supplied_context':suppliedContext});}
