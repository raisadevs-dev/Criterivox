class UnifiedRuntimeResponse {
  final String? characterId, message, event, taskId, journeyId, intent, target, requestedOutput, source, capability, responsibleCharacter, authorization, stateSource, workflowOutcome, status;
  final Map<String, dynamic> entities;
  final double? confidence;
  const UnifiedRuntimeResponse({this.characterId,this.message,this.event,this.taskId,this.journeyId,this.intent,this.entities=const {},this.target,this.requestedOutput,this.confidence,this.source,this.capability,this.responsibleCharacter,this.authorization,this.stateSource,this.workflowOutcome,this.status});
  factory UnifiedRuntimeResponse.fromJson(Map<String,dynamic> j)=>UnifiedRuntimeResponse(
    ...
    authorization:j['unified_authorization'] as String?,stateSource:j['unified_state_source'] as String?,workflowOutcome:j['unified_workflow_outcome'] as String?,status:j['unified_status'] as String?);
