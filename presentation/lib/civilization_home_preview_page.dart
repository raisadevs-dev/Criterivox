        ...
        child: Column(
          ...
          children: [
            ...
            _Rooms(
              home: home,
              onOpen: () {
                if (onOpenOperationalHome !=
                    null) {
                  onOpenOperationalHome!(
                    homeId,
                  );
                  return;
                }
...
class _ResidentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final t =
        criterivox_theme.CriterivoxTheme.of(
      context,
    );
...
class _HomeBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            t.surfaceStrong.withValues(alpha: .9),
        borderRadius:
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Named spatial responsibilities '
            'are visible now; operational '
            'behavior belongs to later Level 2 work.',
            style: TextStyle(
              color: t.mutedText,
              fontSize: 9,
            ),
