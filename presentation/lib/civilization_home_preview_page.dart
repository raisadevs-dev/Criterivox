            ...
            environment: [
              Container(
                decoration: BoxDecoration(
                  ...
                  borderRadius:
                      BorderRadius.circular(v.radiusLarge),
                  border: Border.all(
                    color: t.border,
                  ),
                ),
              ...
              Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'This is the Level 1 Home-entry/read-model '
                      'boundary. Room operations are intentionally '
                      'deferred to the deeper Level 2 implementation.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: t.mutedText,
                        fontSize: 10.5,
