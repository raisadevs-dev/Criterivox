...
class _ShellState extends State<CriterivoxShell> {
  ...
  void handoffFromBloom() {
    ...
    if (foundationId == null || !confirmed) {
      open('stewardship');
      return;
    }
    setState(() => busy = true);
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    _nav('Data Stewardship', Icons.inventory_2_rounded, page == 'stewardship', () => onOpen('stewardship'), expanded, t),
                    ...
                    if (expanded)
                      Padding(
                        ...
                        child: Text(
                          'Navigation moves between surfaces. Bloom provides capability discovery; Data Stewardship is Sandre\'s working surface.',
