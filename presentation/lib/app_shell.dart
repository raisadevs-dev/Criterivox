...
class _TopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: t.page.withValues(alpha: .94),
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Tooltip(
            message: isDarkMode ? 'Switch to day mode' : 'Switch to night mode',
            child: IconButton(
          ...
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.notifications_none_rounded, color: t.text),
          ),
          ...
          CircleAvatar(
            ...
            child: Icon(Icons.person_outline_rounded, color: t.text, size: 19),
          ),
        ],
      ),
    );
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          for (var i = 0; i < 8; i++)
            Transform.rotate(
              angle: i * 3.141592653589793 / 4,
              child: Container(
                width: size * .2,
                height: size * .48,
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(size),
                  color: t.primary.withValues(alpha: .82),
                ),
              ),
            ),
          Container(
