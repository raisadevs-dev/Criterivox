          ...
          child:
            ...
            if (narrow) ...[
              LiveAgentPanel(
                  ...
                  workDescription:
                      'Owns the data foundation: intake, inspection, confirmation, provenance choices, quality and safe downstream handoff.',
                  state: _stateFor('sandre'),
                  onChat: () => onChatCharacter?.call('sandre')),
              const SizedBox(height: 10),
              LiveAgentPanel(
                  characterId: 'kaelen',
                  responsibility: 'Build + Experimentation',
                  workDescription:
                      'Works from Sandre’s validated material to prepare downstream build and experimentation work. Kaelen is a working member, not a passive roommate label.',
                  state: _stateFor('kaelen'),
                  onChat: () => onChatCharacter?.call('kaelen')),
            ] else
