...
class SessionCharacterAnimation {
  ...
  static const activeCharacters = <String>{'anuka','dharen','kaelen','sandre','syvax'};

  static bool supports(String id) => activeCharacters.contains(id.trim().toLowerCase());
...
class SessionCharacterMotion {
  ...
  final int direction;
  const SessionCharacterMotion({required this.duration,required this.phase,required this.sway,required this.lift,required this.emphasis,required this.direction});
}
