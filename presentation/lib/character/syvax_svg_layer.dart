...
class SyvaxSvgLayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: 'Syvax character', value: state,
      child: SizedBox(
          ...
          child: Stack(alignment: Alignment.center, clipBehavior: Clip.none, children: [
            ...
            AnimatedSwitcher(
              ...
              child: CharacterFrame(
                key: ValueKey(frame),
                asset: CharacterVisualAssets.sheetFor('syvax'),
                stateAsset: CharacterVisualAssets.stateFor('syvax', frame),
                index: frame, width: 166, height: 244,
                fallbackAsset: CharacterVisualAssets.sheetFor('syvax'),
              ),
            ),
