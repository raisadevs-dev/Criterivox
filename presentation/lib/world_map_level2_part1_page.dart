...
class _WorldMapLevel2Part1PageState extends State<WorldMapLevel2Part1Page> {
  ...
  Widget _header(CriterivoxTheme t) => Row(children: [IconButton(onPressed: widget.onBack, icon: const Icon(Icons.arrow_back)), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('GATE 1 · CRITERIVOX CIVILIZATION', style: TextStyle(color: t.primary, fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 1.4)), Text('LEVEL 2 · PART I · Supervision Briefing Control Plane', style: TextStyle(color: t.text, fontSize: 25, fontWeight: FontWeight.w800)), Text('Roster → briefing → relationships → network → guest boundary', style: TextStyle(color: t.mutedText, fontSize: 10))]))]);
