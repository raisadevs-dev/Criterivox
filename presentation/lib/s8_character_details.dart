...
class _S8CharacterDetailsPainter extends CustomPainter {
  ...
  void _medrus(Canvas c) {
    ...
    c.drawPath(Path()..moveTo(-17,-57)..lineTo(0,-45)..lineTo(17,-57)..lineTo(11,-30)..lineTo(0,-22)..lineTo(-11,-30)..close(), _fill(const Color(0xFF252C37)));
    c.drawPath(Path()..moveTo(-7,-43)..lineTo(0,-36)..lineTo(7,-43)..lineTo(4,-15)..lineTo(0,-7)..lineTo(-4,-15)..close(), _fill(const Color(0xFFB8A78A)));
    ...
    c.drawRRect(RRect.fromRectAndRadius(const Rect.fromLTWH(33, 18, 13, 7), const Radius.circular(3)), _fill(const Color(0xFF202936)));
    c.drawCircle(const Offset(39.5,21.5), 1.8, _fill(blue));

    // Tablet / evidence slate appears during work, receive or handoff.
    if (state == 'WORK' || state == 'RECEIVE' || state == 'HANDOFF') _tablet(c, const Offset(31, 45), 30, 19, blue);
  }
  ...
  void _epistre(Canvas c) {
    ...
    c.drawPath(Path()..moveTo(-20,-56)..quadraticBezierTo(0,-43,20,-56)..lineTo(13,-28)..lineTo(0,-20)..lineTo(-13,-28)..close(), _fill(const Color(0xFFD8CCBC)));
    ...
    c.drawOval(const Rect.fromLTWH(-29,-86,25,14), frame);
    c.drawOval(const Rect.fromLTWH(4,-86,25,14), frame);
    ...
    if (state == 'WORK' || state == 'RECEIVE' || state == 'HANDOFF') _tablet(c, const Offset(29, 44), 31, 19, violet);
  }
  ...
  void _veridat(Canvas c) {
    ...
    c.drawPath(Path()..moveTo(-17,-58)..lineTo(0,-48)..lineTo(17,-58)..lineTo(11,-31)..lineTo(0,-22)..lineTo(-11,-31)..close(), _fill(const Color(0xFF222934)));
    c.drawPath(Path()..moveTo(-6,-45)..lineTo(0,-38)..lineTo(6,-45)..lineTo(4,-12)..lineTo(0,-6)..lineTo(-4,-12)..close(), _fill(const Color(0xFFD1C5B3)));
    ...
    c.drawRRect(RRect.fromRectAndRadius(const Rect.fromLTWH(-47, 17, 13, 7), const Radius.circular(3)), _fill(const Color(0xFF202936)));
    c.drawCircle(const Offset(-40.5,20.5), 1.8, _fill(green));
    if (state == 'WORK' || state == 'RECEIVE' || state == 'HANDOFF') _tablet(c, const Offset(29, 44), 31, 19, green);
  }
