...
class CollaborationRoom extends StatelessWidget {
  ...
  @override Widget build(BuildContext c)=>Scene(
    ...
    children:[
      const SpatialPanel(title:'ROLES',child:Text('House Owner · Resident · Guest')),
      const SpatialPanel(title:'CONTEXT MASKING WALL',child:Text('PUBLIC_TO_ROOM · RESIDENT_ONLY · OWNER_CONFIDENTIAL · GUEST_MASKED. Backend authorization remains authoritative.')),
