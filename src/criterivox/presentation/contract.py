...
class PresentationContract:
 contract_version:int; character_id:str; character_state:str; animation:str; active:bool; prominence:float; reduced_motion:bool; message:str|None=None; event:str|None=None; task_id:str|None=None; task_state:str|None=None; task_source:str|None=None; task:str|None=None; task_data_fields:int|None=None; task_context_fields:int|None=None; task_created_at:str|None=None; task_updated_at:str|None=None; task_references:tuple[str,...]=(); observations:tuple[dict[str,str],...]=(); findings:tuple[dict[str,str],...]=(); evidence:tuple[dict[str,str],...]=(); activity:tuple[str,...]=(); error:str|None=None
 @classmethod
