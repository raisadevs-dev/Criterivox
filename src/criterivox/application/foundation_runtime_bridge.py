...
async def _publish_raw(payload: dict[str, Any]) -> None:
    """Send a durable computational event without putting authoritative state in the presentation contract."""
