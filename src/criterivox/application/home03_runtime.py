...
class Home03Runtime:
 ...
 def approve(self,task_id,action,diff=None):w=self._ensure(task_id);w.approval=action;w.updated_at=self._now();return self.emit('WORKFLOW_INTERVENTION',task_id,action=action,diff=diff or {})
